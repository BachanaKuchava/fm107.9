...
function News() {
  ...
  // Description text used for Europe news items (for grid/mobile vertical list)
  ...
  // Constant release date (adjust as needed)
  const releaseDate = "06/04/2025";

  useEffect(() => {
    // Existing "American" slider initialization (unchanged)
    ...
    // Updated Mobile slider initialization: moves automatically every 4 seconds
    const mobileSplide = new Splide("#mobile-slider", {
      type: "loop",
      perPage: 1,
      gap: 16,
      autoplay: true,
      interval: 4000, // changed from 6000 to 4000ms
      pauseOnHover: true,
    });
    mobileSplide.mount();
  }, []);
  ...
  useEffect(() => {
    // American slider initialization with responsive options:
    const splide = new Splide("#post-carousel", {
      rewind: true,
      gap: 32,
      autoplay: true,
      ...
      breakpoints: {
        768: {
          perPage: 1,
          interval: 4000, // 4 seconds on mobile
        },
      },
    });
    splide.mount();
  
    // Mobile slider for the hero block (unchanged)
    const mobileSplide = new Splide("#mobile-slider", {
      type: "loop",
      perPage: 1,
      gap: 16,
      autoplay: true,
      interval: 4000, // already set to 4 seconds
      pauseOnHover: true,
    });
    mobileSplide.mount();
  }, []);
      ...
      <div className="bg-white py-6">
        <div className="xl:container mx-auto px-3 sm:px-4 xl:px-2">
          <div className="flex flex-col lg:flex-row gap-4">
            ...
            {/* Right: Desktop Grid Version (4 Smaller Images with text below) */}
            ...
            {/* Mobile Slider Version (4 Smaller Images with text below) */}
